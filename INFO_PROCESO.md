...
![Alt Acciones según comportamiento enemigo](https://github.com/DanixaChan/CodeMage/tree/CodeMage0.2/FotosGifsmd/IdleEnemy_Codemage.gif)
...
## 01
 - El enemigo es capaz de calcular distancias, y según la distancia entre jugador-enemigo cambia estados (actualmente entre escapar, seguir, atacar)
  ...
  ![Radios de distancia de Comportamientos Enemigos](https://github.com/DanixaChan/CodeMage/tree/CodeMage0.2/FotosGifsmd/Radios_ComportamientosEnemigos.PNG)
